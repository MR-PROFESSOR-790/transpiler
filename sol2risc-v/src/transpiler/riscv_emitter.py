...
class RISCVEmitter:
    ...
    def comment(self, text: str) -> None:
        ...
        self.sections[self.current_section].append(f"# {text}")

    def directive(self, directive: str, *args) -> None:
        """Add an assembly directive."""
        line = f"\t.{directive} {', '.join(map(str, args))}"
        self.code.append(line)
        self.sections[self.current_section].append(line)

    def instruction(self, name: str, *args) -> None:
        """Add an assembly instruction."""
        line = f"\t{name} {', '.join(map(str, args))}"
        self.code.append(line)
        self.sections[self.current_section].append(line)
